package com.bcpr.backend.security.config;
...
import com.bcpr.backend.security.filter.CustomAuthenticationFilter;
import com.bcpr.backend.security.filter.CustomAuthorizationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception{
        ...
        http.authorizeRequests().antMatchers("/Stt/**").permitAll();
        //by.지원
